...
\COPY listing_dates FROM 'listing_dates_10.csv' WITH CSV HEADER DELIMITER ',' NULL AS 'null';
\COPY listing_dates FROM 'listing_dates_9.csv' WITH CSV HEADER DELIMITER ',' NULL AS 'null';
